...
#region Compatibility for older games

        public static float musicVolumeDefault {
            get {
                return M8.UserSettingAudio.isInstantiated ? M8.UserSettingAudio.instance.musicVolumeDefault : 0f;
            }
        }

        public static float soundVolumeDefault {
            get {
                return M8.UserSettingAudio.isInstantiated ? M8.UserSettingAudio.instance.soundVolumeDefault : 0f;
            }
        }

        public string lastSoundBackgroundPath { get; private set; }
        public bool lastSoundBackgroundIsLoop { get; private set; }

        public float musicVolume {
            get {
                return M8.UserSettingAudio.isInstantiated ? M8.UserSettingAudio.instance.musicVolume : 0f;
            }
        }

        public float soundVolume {
            get {
                return M8.UserSettingAudio.isInstantiated ? M8.UserSettingAudio.instance.soundVolume : 0f;
            }
        }

        public virtual void PlaySound(string soundPath, bool isBackground, bool isLoop) {
            if(isBackground) {
            ...
            if(isBackground) {
                lastSoundBackgroundPath = soundPath;
                lastSoundBackgroundIsLoop = isLoop;
            }
        }
        ...
        public virtual void StopSound(string path) {
            ...
            if(lastSoundBackgroundPath == path) {
                ...
                lastSoundBackgroundIsLoop = false;
            }
        }
        ...
        protected virtual void ApplyVolumes(float sound, float music, float fade) {
            if(M8.UserSettingAudio.isInstantiated) {
                M8.UserSettingAudio.instance.soundVolume = sound;
                M8.UserSettingAudio.instance.musicVolume = music;
            }
        }

        public void ApplyCurrentVolumes() {
            if(M8.UserSettingAudio.isInstantiated)
                M8.UserSettingAudio.instance.Save();
        }

        public void ApplyVolumes(float sound, float music, bool save) {
            ApplyVolumes(sound, music, 0f, save);
        }

        public void ApplyVolumes(float sound, float music, float fade, bool save) {
            ApplyVolumes(sound, music, fade);

            if(save && M8.UserSettingAudio.isInstantiated)
                M8.UserSettingAudio.instance.Save();
        }
