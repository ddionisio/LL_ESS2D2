...
public struct UnitPoint {
    ...
    public static bool GetGroundPoint(Vector2 position, LayerMask groundLayerMask, out UnitPoint point) {
        ...
        var hit = Physics2D.Raycast(checkPoint, checkDir, levelRect.height, groundLayerMask);
        if(hit.collider) {
